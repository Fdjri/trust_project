...
CREATE TABLE `customers` (
  ...
  `nomor_hp_1` varchar(255) NOT NULL,
  `nomor_hp_2` varchar(255) DEFAULT NULL,
  `kelurahan` varchar(255) DEFAULT NULL,
  `kecamatan` varchar(255) DEFAULT NULL,
  `kota` varchar(255) DEFAULT NULL,
  `tanggal_lahir` date DEFAULT NULL,
  `jenis_kelamin` enum('L','P') DEFAULT NULL,
  `tipe_pelanggan` enum('first buyer','replacement','additional') DEFAULT NULL,
  `jenis_pelanggan` enum('retail','fleet') DEFAULT NULL,
  `pekerjaan` varchar(255) DEFAULT NULL,
  `tenor` int(11) DEFAULT NULL,
  `tanggal_gatepass` date DEFAULT NULL,
  `model_mobil` varchar(255) DEFAULT NULL,
  `nomor_rangka` varchar(255) DEFAULT NULL,
  `sumber_data` varchar(255) DEFAULT NULL,
  `progress` enum('pending','tidak ada','SPK') NOT NULL DEFAULT 'pending',
...
CREATE TABLE `follow_ups` (
  ...
  `status` enum('pending','spk','rejected') NOT NULL,
...
CREATE TABLE `histories` (
  ...
  `total_followups` int(11) NOT NULL DEFAULT 0,
  `total_spk` int(11) NOT NULL DEFAULT 0,
...
(1, '2025_03_08_052143_create_branches_table', 1),
(2, '0001_01_01_000000_create_users_table', 2),
(3, '0001_01_01_000001_create_cache_table', 2),
(4, '0001_01_01_000002_create_jobs_table', 2),
(5, '2025_03_08_052259_create_customers_table', 2),
(6, '2025_03_08_052550_create_permission_tables', 2),
(7, '2025_03_15_165008_create_sessions_table', 2),
(8, '2025_04_13_134519_create_follow_ups_table', 2),
(9, '2025_04_15_012528_create_follow_ups_table', 3),
(10, '2025_04_15_012640_create_histories_table', 3);
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','kepala_cabang','supervisor','salesman') NOT NULL,
...
ALTER TABLE `follow_ups`
  ...
  ADD KEY `follow_ups_salesman_id_foreign` (`salesman_id`);
...
ALTER TABLE `histories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `histories_salesman_id_foreign` (`salesman_id`),
  ADD KEY `histories_branch_id_foreign` (`branch_id`);
...
ALTER TABLE `customers`
  ...
  ADD CONSTRAINT `customers_salesman_id_foreign` FOREIGN KEY (`salesman_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `follow_ups`
--
ALTER TABLE `follow_ups`
  ADD CONSTRAINT `follow_ups_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id_customer`),
  ADD CONSTRAINT `follow_ups_salesman_id_foreign` FOREIGN KEY (`salesman_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `histories`
--
ALTER TABLE `histories`
  ADD CONSTRAINT `histories_branch_id_foreign` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `histories_salesman_id_foreign` FOREIGN KEY (`salesman_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
